...
function LoginLink() {
  ...
  return (
    <Link
      ...
      className="px-8 py-3 rounded-full border border-gray-600 text-white font-bold tracking-widest text-xs uppercase hover:bg-white/5 transition-colors duration-300 w-full max-w-[200px] text-center"
    >
      Sign In
    </Link>
  );

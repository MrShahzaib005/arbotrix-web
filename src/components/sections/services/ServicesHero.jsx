...
export default function ServicesHero() {
  ...
  return (
    <section className="relative pt-40 pb-24 px-6 flex items-center justify-center min-h-[70vh] border-b border-gray-900 overflow-hidden">
      ...
      {/* Code-Only Circuit/Particle Effect */}
      {mounted && (
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center">
        ...
        >
          {/* Converted invalid button nesting into a clean styled Link */}
          <Link 
            href="/contact" 
            className="group relative flex items-center justify-center px-8 py-4 font-bold text-white transition-all duration-300 bg-accent-blue hover:bg-blue-600 rounded-full shadow-[0_0_20px_rgba(0,163,255,0.3)] hover:shadow-[0_0_30px_rgba(0,163,255,0.5)] overflow-hidden w-full sm:w-auto"
          >

...
const HARDWARE = [
  {
    ...
    // Swapped from emerald to industrial yellow/amber
  ...
  },
  {
    ...
    bgAccent: "bg-blue-500/10 border-blue-500/20 text-blue-500",
  ...
  },
  {
    ...
    link: "/products/aero-drone" // The outbound route
  },
];
          ...
          {HARDWARE.map((item, i) => (
            ...
            >
              <div className="h-56 bg-slate-50 border-b border-gray-100 relative overflow-hidden flex items-center justify-center p-4">
                ...
                />
                <div className={`absolute top-5 left-5 px-3 py-1 rounded-full border text-[9px] font-heading font-black uppercase tracking-[0.2em] ${item.bgAccent} ${item.accent} z-20 shadow-sm`}>
                </div>
              </div>
              ...
              <div className="p-8 flex-1 flex flex-col bg-white">
                ...
                <div className="pt-6 border-t border-gray-100 mt-auto flex items-center justify-between">
                  {item.link ? (
                    <Link href={item.link} className="w-full flex items-center justify-between text-[11px] font-heading font-black text-slate-900 uppercase tracking-widest group-hover:text-blue-600 transition-colors">
                      View Specifications

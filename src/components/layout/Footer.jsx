...
//   return (
//     <footer className="bg-[#0B0D14] text-white py-16 border-t border-gray-900">
...
// export default function Footer() {
//   return (
//     <footer className="relative bg-[#0B0D14] text-white pt-20 pb-8 border-t border-gray-900 overflow-hidden">
...
export default function Footer() {
  return (
    <footer className="bg-[#0B0D14] text-white pt-16 pb-8 border-t border-gray-900">
